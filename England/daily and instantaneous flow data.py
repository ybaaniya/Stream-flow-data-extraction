...
# Load the CSV file
file_path = 'path to england stations.csv'
data = pd.read_csv(file_path)
data = data.dropna(subset=['stationGuid'])

# Define directories for flow-m and flow-i
flow_m_dir = 'path to folder to store daily discarge data'
flow_i_dir = '/path to folder to store instantaneous discarge data'

# Create directories if they don't exist
os.makedirs(flow_m_dir, exist_ok=True)
os.makedirs(flow_i_dir, exist_ok=True)
